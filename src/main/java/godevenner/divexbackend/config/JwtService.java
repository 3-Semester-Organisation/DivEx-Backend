...
public class JwtService {
    ...
    //In general a JWT has 3 parts to it, HEADER, PAYLOAD and VERIFY SIGNATURE. Inside the payloads there are claims
    //such as token expatriation- and creation date. In general the PAYLOAD contains information about the user
    public <T> T extractClaim(String token, Function<Claims, T> claimsResolver) {
        final Claims claims = extractAllClaims(token);
        return claimsResolver.apply(claims);
    }

    //TODO dont use depricated methods.
