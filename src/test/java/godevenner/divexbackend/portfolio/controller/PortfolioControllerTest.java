...
class PortfolioControllerTest {
    ...
    void testGetPortfolios() {
        ...
        Assertions.assertEquals(new ResponseEntity<List<Portfolio>>(List.of(new Portfolio(0L, "portfolioName", new User(1L, "username", "email", "password", "firstName", "lastName", "phone", "address", "city", new Subscription(1L, true, SubscriptionType.PREMIUM, LocalDateTime.of(2024, Month.DECEMBER, 1, 17, 19, 18), LocalDateTime.of(2024, Month.DECEMBER, 1, 17, 19, 18))))), null, 200), result);
    }
